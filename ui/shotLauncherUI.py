...
for attempt in range(3):
    try:
        ...
        from PyQt5.QtWidgets import (
            ...
            QAbstractButton, QStackedWidget, QCheckBox
        )
...
class OrionLauncherUI(QWidget):
    ...
    def init_ui(self):
        ...
        # Initial Load
        self.populate_sidebar(self.current_context)
    ...
    #LOGIC
    def populate_sidebar(self, mode):
    ...
    def switch_context(self, mode):
        ...
        self.populate_sidebar(self.current_mode)
